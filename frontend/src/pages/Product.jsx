      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex items-center gap-1 mt-2'>
            {/* <img src={assects.star_icon} alt="" className="w-3 5" />
            <img src={assects.star_icon} alt="" className="w-3 5" />
            <img src={assects.star_icon} alt="" className="w-3 5" />
            <img src={assects.star_icon} alt="" className="w-3 5" />
            <img src={assects.stardull_icon} alt="" className="w-3 5" /> */}
            <p>(122)</p>
          </div>
          ...
          <div className='flex flex-col gap-4 my-8'>
            ...
            <div className='flex gap-2'>
              {productData.sizes.map((item,index)=>(
                <button onClick={()=>setSize(item)} className={`border-1 py-2 px-4 bg-gray-200 ${item===size ? 'border-orange-500' : ''}`} key={index}>{item}</button>
              ))}
            </div>
          </div>
